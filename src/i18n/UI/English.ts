export const English = {
  ...
  messages: {
    ...
    viewProviderAccount:
      "You do not have a provider account please create one to view your provider profile.",
  ...
  productCategoryInfo: {
    categories: [
      {
        name: "Gardening",
        description: "Get help with your garden and landscaping.",
        ariaLabel: "Gardening",
        id: "1",
      },
      {
        name: "Construction",
        description: "New Construction, Additions, or Repair Services",
        ariaLabel: "Construction",
        id: "3",
      },
      {
        name: "Beauty",
        description: "Salons, Barbers, and other personal care.",
        ariaLabel: "Beauty",
        id: "2",
      },
      {
