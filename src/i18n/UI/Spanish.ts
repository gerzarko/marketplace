export const Spanish = {
  ...
  messages: {
    ...
    passwordLength:
      "La contraseña debe contener 6 caracteres como mínimo, contener al menos una letra mayúscula, una letra minúscula,un número y un carácter especial.",
    ...
    signInAsProvider:
      "Inicie sesión en una cuenta de proveedor antes de publicar.",
    checkEmail: "¡Revise su correo electrónico para ver el enlace de reinicio!",
    checkConfirmEmail:
      "¡Revisa tu correo electrónico para el link de confirmación!",
  ...
  productCategoryInfo: {
    categories: [
      {
        name: "Jardinería",
        description: "Obtenga ayuda con su jardín y paisajismo.",
      ...
      {
        name: "Belleza",
        description: "Salones, Barberos, y otros cuidados personales.",
        ariaLabel: "Belleza",
        id: "2",
      },
      {
      ...
      {
        name: "Viajar",
        description: "Servicios de viaje",
        ariaLabel: "Viajar",
        id: "13",
      },
